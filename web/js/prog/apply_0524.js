...
function familyFoolproof(family, familyName, validArr) {
    ...
    validArr.validEmpty_arr.push({
        ...
        msg: '' + familyName + '戶籍電話',
        group: '' + familyName + 'domicilePhone'
    });
    validArr.validEmpty_arr.push({
    ...
    if(family == guarantor+'_'){
        mobile_numObj['hasHiddenCode'] = true;
        mobile_numObj['hiddenTarget'] = $('div#'+guarantor+' input[name="mobile_hidden"]').val()
    }
    ...
    if(family == guarantor+'_'){
        ...
        id_numObj['hiddenTarget'] = $('div#'+guarantor+' input[name="id_hidden"]').val()
    }
    ...
    if(family == guarantor+'_'){
        ...
        mobileObj['hiddenTarget'] = $('div#'+guarantor+' input[name="mobile_hidden"]').val()
    }
    ...
    if(family == guarantor+'_'){
        ...
        nameObj['hiddenTarget'] = $('div#'+guarantor+' input[name="name_hidden"]').val()
    }
