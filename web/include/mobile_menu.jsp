...
<nav id="mobileMenu_left_area" class="mobileMenu_left_area">
  <ul>
    ...
    <li><a href="<%=isLogin ? "apply_00.jsp" : "memberLogin.jsp"%>" class="applyBtn" >我要申請</a></li>
    <li><a href="javascript:;">帳務查詢</a>
      <ul>
        <li><a href="<%=isLogin ? "myloan.jsp" : "memberLogin.jsp"%>">我的貸款</a></li>
        <li><a href="<%=isLogin ? "personalInfo_start.jsp" : "memberLogin.jsp"%>">還款明細查詢</a></li>
      </ul>
    </li>
    ...
    <li><a href="javascript:;">繳款資訊</a>
      <ul>
        ...
        <li><a href="<%=isLogin ? "myElectronicPay_1.jsp" : "memberLogin.jsp"%>">我的電子繳款單</a></li>
        <!--<li><a href="javascript:;" onclick="alert('系統建置中');return false;">立即繳款</a></li>-->
      </ul>
    </li>
    <li><a href="javascript:;">個人資料</a>
      <ul>
        <li><a href="<%=isLogin ? "personalInfo_start.jsp" : "memberLogin.jsp"%>">變更基本資料</a></li>
        <li><a href="<%=isLogin ? "changePwd.jsp" : "memberLogin.jsp"%>">變更代碼/密碼</a></li>
      </ul>
    </li>
  </ul>
</nav>
