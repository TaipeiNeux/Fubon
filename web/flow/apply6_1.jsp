<%@ page language="java" contentType="text/html; charset=utf-8" %>
    ...
    <div class="joy nina">
        ...
        <div class="right">
            <p class="nike">您已成功送出申請資料!本行將儘速審核您的案件。</p>
        </div>
    </div>
    <div class="joy nina">
        <div class="left">
...
<div class="barniv">
    <h4>您已順利完成線上續貸申請，本行將進行審核作業，會以 E-Mail 通知您審核結果。</h4>
    <p>若審核結果為「
        <img src="img/na-14.png" alt="">通過｣時，請您再次進入本功能列印申請書(收執聯)交付學校。</p>
    <p>若審核結果為「
        <img src="img/deny.png" alt="">未通過｣時，請您依據不通過之原因，再次進入本功能儘速修改後重新送出申請。</p>
</div>