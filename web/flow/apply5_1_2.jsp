<%@ page language="java" contentType="text/html; charset=utf-8" %>
    <% request.setCharacterEncoding( "utf-8"); %>
        ...
        <br>
        <h4 class="mipa">請輸入本行寄發到您手機號碼<div class="mipa" id="mobile">09111111111</div></h4><h4 class="mipa">的六位數交易驗證碼;<div>如有疑問,請洽本行客服專線 02-8751-6665 按 5。</div></h4>
        <div class="joy finp">
            <div class="left">
                <p>交易代碼</p>
            </div>
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      <h3>本次交易可輸入交易驗證碼的時間已逾時，請重新操作</h3>
	        ...
	        <a href="#" class="pobtn-srb submitBtn" style="">確定</a>
	    </div>
	  </div>
	</div>
</div>