...
public class ForgetPassword3_2 implements ILogic {
    ...
    public void getDraftData(JSONObject content, Document draftData, JSPQueryStringInfo queryStringInfo) throws Exception {
        ...
        if("Y".equalsIgnoreCase(isRecord)) {
            ...
            MessageUtils.saveOTPLog(dao,mobile,null,queryStringInfo.getRequest(),otpBean.getOtpNumber(),otpBean.getOtpCode(),smsBean.getContent(),id);
        ...
        //如果沒撥款，發Email
            ...
            MessageUtils.saveOTPLog(dao,null,email,queryStringInfo.getRequest(),otpBean.getOtpNumber(),otpBean.getOtpCode(),null,id);
        }
