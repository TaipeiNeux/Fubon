...
<br>
<h4 class="mipa">請於下方輸入本行寄發到您<span class="sendType"></span> <span class="sendType_val"></span> 的六位數交易驗證碼；
...
<div class="parents">
	...
	<div class="joy finp">
	  ...
	  <div class="right">
	    <input placeholder="請輸入六位數交易驗證碼" class="verfi input_L" type="text" name="trasactionCode_val">
	    <div class="error-msg"/>
...
<div class="modal fade pomodal forgetPwd" id="modal_forgetPwd_2_2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
